...
public class MainMenu {
	...
	public static void filterRooms(double distanceFromCityCenterMin, double distanceFromCityCenterMax, int starsMin, int starsMax, int priceMin, int priceMax, String[] facilities, int visitorRating) {
        ...
        //TODO$$ IF VALUE IS BLANK ASSIGN VALUE 
		...
		for(int i=0;i<=counterOfFindings;i++) {
			...
			if(addToFilteredList == true) {
				...
				System.out.println("dd " + tempRoom.printAll());
				//System.out.println();
    ...
    public static void reservationProcess(BasicPersonInfo browsingUser, String firstName, String lastName, int age, String email, String phoneNumber, String idOfSelectedHotel, String additionalComments) {
         ...
         String reservationID = firstName.charAt(0) + lastName.charAt(0) + idOfSelectedHotel; //TODO: use hash function to generate legit one or serialization
    ...
    public static void emailSubmission(ReservationProfile reservation) { //TODO$$ add filewriter
    ...
    public static void readSeminars() {
        ...
        try {
            ...
            if (file.exists()) {
                ...
                String line = inStream.readLine();  // reads only ONE line -> a while loop must be used to read the whole file
	...
	public static void main(String[] args) {
        ...
        String checkInDate = "2018-04-01";
        String checkOutDate = "2018-04-03";
		...
		//displayRatingsOrderAscending();
		//displayRatingsOrderDescending();
		//displayPricingOrderAscending();
        ...
        //String[] ff = {"parking"};
		//filterRooms(0.0,35.0, 0, 5, 0, 10000, ff, 90);
		//filteredEnabled = true;
       ...
       // Singleton.getInstance().check = "yeah boy";
        
        //reservationProcess(browsingUser); 
       /* readSeminars();
        System.out.println("Seminar Check:");
        for(int i=0;i<seminarArray.length;i++) {
            System.out.println(seminarArray[i].getName());
        }*/
	}
